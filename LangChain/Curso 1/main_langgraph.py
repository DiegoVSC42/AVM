...
prompt_consultor_praia = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            "Se apresente como Sra praias, Voce é um consultor de viagens especializado em praias",
        ),
        ("human", "{query}"),
    ]
)
...
prompt_consultor_montanhas = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            "Se apresente como Sr montanha. Voce é um consultor de viagens especializado em montanhas",
        ),
        ("human", "{query}"),
    ]
)
...
cadeia_montanha = prompt_consultor_montanhas | modelo | StrOutputParser()
...
async def main():
    resposta = await app.ainvoke({"query": "Quero visitar um lugares altos"})
